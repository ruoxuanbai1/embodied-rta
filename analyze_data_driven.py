...
核心修正:
1. GT 从数据中学习真实关节范围，不用硬编码限位
2. GT: 使用数据中 qpos 的 p1/p99 作为"安全范围"，超出 p0.5/p99.5 为危险
3. R1 alarm: 用更宽松的范围 (p5/p95) 作为预警
4. 每 10 集保存一次
"""
...
JOINT_SAFE_RANGE = [
    (-1.85, 1.26),    # joint 0
    (-2.12, -0.96),   # joint 1 - 数据中实际范围
    (0.11, 1.57),     # joint 2
    (-0.16, 1.25),    # joint 3
    (-0.30, 3.51),    # joint 4
    (-2.43, 0.00),    # joint 5
    (0.08, 2.73),     # gripper left - 数据中范围很大！
